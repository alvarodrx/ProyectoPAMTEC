    ...
    <div id="mainMenuBar" class="mainMenuBar w-100 shadow">
        ...
        <div class="btn-group-vertical" style="width: 100%">
            <div class="btn-group btn-group-lg w-auto" role="group" aria-label="...">
                ...
                <div>
                    <h3 class="mt-2 ml-5">${cursoName}<span class="text-muted"> Pasar Lista</span></h3>
                </div>
            </div>
    ...
    <div class="d-flex justify-content-center overflow-scroll p-lg-4">
        ...
        <div class="overflow-scroll w-75 h-100 p-4">
            ...
            <table class="table h-auto w-100">
                ...
                <tbody>
                <tr class="table-secondary" id="row-3">
                    <th scope="row">1</th>
                    <td>Ana Maria Cortes</td>
                    ...
                    <td class="text-center">
                        <label class="container mx-auto">
                            <input type="radio" name="radio" value="Ausente">
                            <span class="checkmark"></span>
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="container mx-auto">
                            <input type="radio" name="radio" value="Justificado" onclick="justificarEstudiante(3);">
                            <span class="checkmark"></span>
                        </label>
                    </td>
                </tr>
                <tr class="table-secondary" id="row-2">
                    <th scope="row">2</th>
                    <td>Ana Maria Cortes</td>
                    <td class="text-center">
                        <label class="container mx-auto">
                            <input type="radio" name="radioEst1" value="Presente">
                            <span class="checkmark"></span>
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="container mx-auto">
                            <input type="radio" name="radioEst1" value="Ausente">
                            <span class="checkmark"></span>
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="container mx-auto">
                            <input type="radio" name="radioEst1" value="Justificado" onclick="showModalJustificacion(2, '#estudianteModal');">
                            <span class="checkmark"></span>
                        </label>
                    </td>
                </tr>
                <tr class="table-success" id="row-1">
                    <th scope="row">3</th>
                    <td>Ana Maria Cortes</td>
                    <td class="text-center">
                        <label class="container mx-auto">
                            <input type="radio" name="radioAsist1" value="Presente">
                            <span class="checkmark"></span>
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="container mx-auto">
                            <input type="radio" name="radioAsist1" value="Ausente">
                            <span class="checkmark"></span>
                        </label>
                    </td>
                    <td class="text-center">
                        <label class="container mx-auto">
                            <input type="radio" name="radioAsist1" value="Justificado" onclick="showModalJustificacion(1, '#asistenteModal');">
                            <span class="checkmark"></span>
                        </label>
                    </td>
                </tr>
        ...
        <div class="modal-content bg-dark">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="justificacionEstudiante-text" class="col-form-label text-light">Ingrese la justificaci&oacute;n de la ausencia:</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="justificarEstudiante($('#estudianteID').val(), $('#justificacionEstudiante-text').val());">Guardar</button>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="asistenteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-dark">
            <div class="modal-header">
                <h5 class="modal-title text-light" id="exampleModalLabel">Justificaci&oacute;n de ausencia.</h5>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="justificacionAsistente-text" class="col-form-label text-light">Ingrese la justificaci&oacute;n de la ausencia:</label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                <button type="button" class="btn btn-primary" onclick="justificarAsistente($('#asistenteID').val(), $('#justificacionAsistente-text').val());">Guardar</button>
            </div>
        </div>
    </div>
</div>
